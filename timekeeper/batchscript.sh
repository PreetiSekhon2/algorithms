...
# type python3.7
# will give the path for shebang

# chmod 755 timekeeper/batchscript.sh
# chmod 755 timekeeper/bubblesort.py
# chmod 755 timekeeper/duplicates.py
# chmod 755 timekeeper/mechacoach.py
# chmod 755 timekeeper/mostfrequentwords.py
# chmod 755 timekeeper/reversearray.py
# chmod 755 timekeeper/selectionsort.py
# chmod 755 timekeeper/subsequencesum.py
# chmod 755 timekeeper/testpythoninbuilt.py
